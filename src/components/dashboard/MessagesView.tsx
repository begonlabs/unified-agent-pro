      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {mobileView === 'chat' && selectedConversation && (
          <div className="sm:hidden flex-1 flex flex-col bg-white">
            ...
            {/* Área de mensajes con scroll independiente */}
            <div className="flex-1 overflow-y-auto p-3" style={{ backgroundImage: 'url(/chat-background.jpg)', backgroundSize: '800px', backgroundRepeat: 'repeat', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
        ...
        <div className="hidden sm:flex flex-1 flex-col bg-white">
          {selectedConversation ? (
            <>
              ...
              {/* Messages con scroll independiente */}
              <div className="flex-1 overflow-y-auto p-3 sm:p-4" style={{ backgroundImage: 'url(/chat-background.jpg)', backgroundSize: '800px', backgroundRepeat: 'repeat', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
            ...
            <div className="flex-1 flex items-center justify-center" style={{ backgroundImage: 'url(/chat-background.jpg)', backgroundSize: '800px', backgroundRepeat: 'repeat', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
